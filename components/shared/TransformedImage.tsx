...
const TransformedImage = ({image, type, title, transformationConfig, isTransforming, setIsTransforming, hasDownload = false }: TransformedImageProps) => {
 ...
 const downloadHandler=()=>{
  ...
  //...transformationconfig will contain all the config that we are going to apply to our image
  // debounce will not be invoked automatically we need to invoke it using () brackets 
    return (
